...
function handleVideo(stream) {
    ...
    button.onclick = function() {
      ...
      xhr.onreadystatechange = function() {
          ...
          newImg.src = "Cama-gru/" + xhr.responseText;
          newImg.onclick = function(event) {
            ...
            xhr.open("POST", "./forms/removecamagru.php", true);
      ...
      xhr.open("POST", "./forms/camagru.php", true);
      xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
function sendCamagru(imgData64, filterImg) {
  var xhr = new XMLHttpRequest();
  xhr.onreadystatechange = function() {
    if (xhr.readyState == 4 && (xhr.status == 200 || xhr.status == 0) && xhr.responseText != null && xhr.responseText != "") {
      var newImg = document.createElement("IMG");
