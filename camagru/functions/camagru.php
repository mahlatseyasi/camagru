...
function add_camagru($userId, $imgPath) {
...
function remove_camagru($uid, $img) {
  include_once '../setup/database.php';
...
function get_camagru2($start, $nb) {
  include_once '../setup/database.php';
...
function get_userinfo_from_camagru($imgSrc) {
  include '../setup/database.php';
